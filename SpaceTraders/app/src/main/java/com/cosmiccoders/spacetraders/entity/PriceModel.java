...
class PriceModel {
    private List<String> WaterList = Arrays.asList("0", "0", "2", "30", "3", "4", "DROUGHT",
            "LOTSOFWATER", "DESERT", "30", "50");
    private List<String> FursList = Arrays.asList("0", "0", "0", "250", "10", "10", "COLD",
            "RICHFAUNA", "LIFELESS", "230", "280");
    private List<String> FoodList = Arrays.asList("1", "0", "1", "100", "5", "5", "CROPFAIL",
            "RICHSOIL", "POORSOIL", "90", "160");
    private List<String> OreList = Arrays.asList("2", "2", "3", "350", "20", "10", "WAR",
            "MINERALRICH", "MINERALPOOR", "350", "420");
    private List<String> GamesList = Arrays.asList("3", "1", "6", "250", "-10", "5", "BOREDOM",
            "ARTISTIC", "never", "160", "270");
    private List<String> FireArmsList = Arrays.asList("3", "1", "5", "1250", "-75", "100", "WAR",

...
/**
 * This class represents a specific trade good, Firearms, that extends the TradeGoods class
 */
public class Firearms extends TradeGood {
    /**
     * This is the constructor for Firearms that call the constructor in TradeGoods
     */
    public Firearms() {
